...
- **实时转换**：输入韩文后显示转换结果；初次打开时输入区和结果区留空。
...
- **桌面与手机布局**：桌面词典侧栏关闭后保留位置；手机端提供紧凑工具栏、页脚信息及词典面板。
- **12 种界面语言**：简体中文、한국어、English、日本語、Français、Español、Русский、Tiếng Việt、Монгол、العربية、ไทย、Bahasa Indonesia。释义译文依词典实际收录情况显示。
